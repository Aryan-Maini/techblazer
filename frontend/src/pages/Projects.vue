    ...
    <div class="container py-4">
      ...
      <div class="row row-cols-1 row-cols-md-2 g-4 mb-4">
        <div v-for="(project, index) in filteredProjects" :key="index" class="col">
          <div
            class="card h-100 border border-white border-opacity-10 bg-white bg-opacity-5 rounded-4 p-4 hover-profile-card transition-all"
          ...
          >
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
              <span
                ...
                :class="project.category === 'IT' ? 'text-cyan' : 'text-gold'"
            ...
            <div class="mb-3">
              <button
                ...
                class="btn btn-sm btn-outline-light-custom rounded-pill px-3 py-1-5 fw-semibold transition-all"
              >
                More Detail
              </button>
            </div>
      ...
      <div v-if="activeModalType" class="detail-modal-overlay" @click.self="closeDetails">
        ...
        >
          ...
          <div class="d-flex align-items-center gap-3 mb-4">
            <!-- Profile Avatar Image or Initials (Modal) -->
            <div class="position-relative flex-shrink-0" style="width: 80px; height: 80px;">
              <img
                ...
                :alt="activeItem.name"
                class="rounded-circle object-fit-cover border border-white border-opacity-20"
                style="width: 80px; height: 80px;"
              />
              <div
                v-else
                class="d-flex align-items-center justify-content-center rounded-circle border border-white border-opacity-20 text-white fw-bold"
                :style="
            ...
            <div>
              <h2 class="h4 fw-bold text-white mb-1">{{ activeItem.name }}</h2>
              <span
                class="text-uppercase tracking-wider small fw-semibold"
                :class="activeItem.industry === 'IT' ? 'text-cyan' : 'text-gold'"
                style="font-size: 0.75rem"
              >
          ...
          <div class="mb-4">
            ...
            <p class="text-white-80 small mb-0" style="line-height: 1.6">
            ...
            <div class="d-flex flex-column gap-2">
              ...
              >
                <div>
                  ...
                  <span
                    class="text-uppercase tracking-wider small fw-semibold"
                    :class="proj.category === 'IT' ? 'text-cyan' : 'text-gold'"
        ...
        >
          ...
          <div class="d-flex justify-content-between align-items-start mb-4">
            <div class="pe-4">
              <span
                class="text-uppercase tracking-wider small fw-semibold mb-1.5 d-block"
                :class="activeItem.category === 'IT' ? 'text-cyan' : 'text-gold'"
                style="font-size: 0.75rem"
              >
                {{ activeItem.category }} Project
              </span>
              <h2 class="h4 fw-bold text-white mb-0">{{ activeItem.title }}</h2>
            </div>
            <div
              class="project-dot mt-2 flex-shrink-0"
              :style="
                activeItem.category === 'IT'
                  ? 'background-color: #4da3ff;'
                  : 'background-color: #ffd200;'
              "
            ></div>
...
.detail-modal-content {
  ...
  box-shadow:
    ...
    0 0 40px rgba(77, 163, 255, 0.15) !important;
  max-width: 580px;
  width: 100%;
  max-height: 85vh;
  overflow-y: auto;
